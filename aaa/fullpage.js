...
!(function (n, t) {
      ...
      (Array.from =
        ...
        function (n) {
          ...
          for (var u, l = i(o.length), c = t(e) ? Object(new e(l)) : new Array(l), s = 0; s < l; )
            (u = o[s]), (c[s] = a ? (void 0 === r ? a(u, s) : a.call(r, u, s)) : u), (s += 1);
          return (c.length = l), c;
        }));
  var o = window,
    r = document,
      ...
      if (i)
        for (var o in i)
          i.hasOwnProperty(o) &&
            "__proto__" != o &&
            "constructor" != o &&
            ("[object Object]" !== Object.prototype.toString.call(i[o]) ? (n[o] = i[o]) : (n[o] = g(n[o], i[o])));
    }
    return n;
  }
  function m(n, t) {
  ...
  function $(n, t, e) {
    var i;
    (e = void 0 === e ? {} : e),
      "function" == typeof o.CustomEvent ? (i = new CustomEvent(t, { detail: e })) : (i = r.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, e),
      n.dispatchEvent(i);
  }
  function Q(n, t) {
      ...
      (Mt = function (s) {
        ...
        if (vn.K) {
          ...
          e && (v = o.fp_easings[tt().easing](f, a, u, e)),
            f <= e && pt(n, v),
            f < e ? window.requestAnimationFrame(Mt) : void 0 === i || l || (i(), dn({ K: !1 }), (l = !0));
  ...
  function Ct(n) {
    tt().lazyLoading &&
      p("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", vt(n)).forEach(
        function (n) {
          if (
  ...
  function Nt(n, t, e) {
    ...
    tt().anchors.length &&
      !tt().lockAnchors &&
      (n ? (null != e && (i = e), null == t && (t = n), dn({ _: t }), Bt(i + "/" + t)) : null != n ? (dn({ _: t }), Bt(e)) : Bt(e)),
      zt();
  }
  function Bt(n) {
  ...
  function Kt() {
    var n = F(this, En);
    m(this, Gn)
      ? _t().m.left && (dn({ N: "slideArrow" }), fn.L("moveSlideLeft", { section: n }))
      : _t().m.right && (dn({ N: "slideArrow" }), fn.L("moveSlideRight", { section: n }));
  }
  function Gt() {
    clearTimeout(Wt);
  }
        ...
        : (D(t, An),
          ...
          (function (n, t, e) {
            ...
            if (
              ((i = t.slidesNav),
              (o = t.slideIndex),
              tt().slidesNavigation && null != i && (j(p(xn, i), An), D(p("a", p("li", i)[o]), An)),
    ...
    (e = n),
      ...
      (function (n, t) {
        ...
        tt().navigation &&
          ...
          (j(p(xn, e), An), D(n ? p('a[href="#' + n + '"]', e) : p("a", p("li", e)[t]), An));
      })(n, t);
  }
  ...
  function me(n) {
    var t = we();
    n
      ? t || (Jt(!1, "internal"), he(!1, "internal"), O(p(jn)), D(At, yn), Y(tt().afterResponsive) && tt().afterResponsive.call(nt(), n))
      : t &&
    ...
    Me = {
      ...
      Ln:
        ...
        function (n) {
          ...
          (Te = t),
            Y(tt().onScrollOverflow) && jt("onScrollOverflow", { position: t, direction: e }),
            m(n.target, In) && vn.G && Me.Pn(e, n.target) && Me.Cn() && fn.L("onScrollOverflowScrolled", { direction: e });
        }),
    },
    Ae = null,
    xe = null;
          ...
          (function (n) {
            ...
            N(p(zn, t)[0], e),
              ...
              "#fff" !== tt().controlArrowColor &&
                (y(p(Yn, t), { "border-color": "transparent transparent transparent " + tt().controlArrowColor }),
                y(p(qn, t), { "border-color": "transparent " + tt().controlArrowColor + " transparent transparent" })),
  ...
  fn.j("bindEvents", function () {
    var n, t, e;
    tt().observer && "MutationObserver" in window && p(bn)[0] && ((n = p(bn)[0]), (t = ze), (e = new MutationObserver(Ne)).observe(n, t), (Le = e)),
  ...
  function di(n) {
    ...
    if (hi(n)) {
      ...
      dn({ q: u ? (li > si ? "right" : "left") : l }),
        u
          ? !vn.H && a && (li > si ? _t().m.right && fn.L("moveSlideRight", { section: t }) : _t().m.left && fn.L("moveSlideLeft", { section: t }))
  ...
  function mi(n) {
    ...
    return (
      ...
      l && hi(n) && tt().scrollBar && void 0 !== n.touches && ((t.y = n.touches[0].pageY), (t.x = n.touches[0].pageX)),
      t
    );
  }
  function wi(n) {
  ...
  function Fi(n) {
    n
      ...
      : (r.addEventListener ? (G("mousewheel", Ni, !1), G("wheel", Ni, !1), G("MozMousePixelScroll", Ni, !1)) : r.detachEvent("onmousewheel", Ni),
  ...
  function Ni(n) {
        ...
        if (hn().B) {
          if (e) {
            ...
            if (!(i || (Xe("isNewKeyframe", "beyondFullpage") && _e.Bn())))
              return (o = ht(rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight)).element.scrollTo(0, o.options), dn({ Hn: !1 }), V(t), !1;
    ...
    if (tt().autoScrolling && !ii && !e) {
      ...
      var s = t - Ci;
      return (
        (Ci = t), s > 200 && (zi = []), dn({ Y: c }), vn.G && an(zi, 10) >= an(zi, 70) && l && (dn({ N: "wheel" }), ei(a < 0 ? "down" : "up")), !1
      );
    }
  ...
  function ro(n) {
    dn({ N: "menu" }),
      !p(tt().menu)[0] || (!tt().lockAnchors && tt().anchors.length) || (V(n), fn.L("onMenuClick", { anchor: U(this, "data-menuanchor") }));
  }
  function ao(n) {
    var t = n.target;
  ...
  function so(n) {
    ...
    if (!vn.W && hn().F && (rn(hn().C), !hn().B && !hn().Hn && (!tt().autoScrolling || tt().scrollBar))) {
      ...
      if (
        ...
        (r = o + w()),
        ("up" == i ? r >= H() + w() : o <= H()) && (m(hn().F.item, On) || (D(hn().F.item, On), j(W(hn().F.item), On))),
        (e = (t = f[l]).item),
        !t.isActive)
      ) {
        dn({ V: !0 });
  ...
  function wo() {
    ...
    "" === tt().licenseKey.trim()
      ...
      ? n && n.length
      : (v("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"), v("error", "https://alvarotrigo.com/fullPage/pricing")),
      m(xt, Mn)
